# About
This repository contains source code for a Biologically Aligned Modular RNN network of cat's V1.
...
- `execute_model.py` - This file serves as an user interface for execution of the model (both training and evaluation).
...
```bash
/CSNG/V1ModelMLData/dataset/
```
To run the model correctly either move the `dataset/` directory to the base of the repository, or adjust the input paths in `nn_model/globals.py` file.
